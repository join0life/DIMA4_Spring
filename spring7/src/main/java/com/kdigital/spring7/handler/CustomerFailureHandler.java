...
public class CustomerFailureHandler extends SimpleUrlAuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		if(exception instanceof BadCredentialsException) { // BadCredentialsException : 아이디나 비밀번호가 잘못됐을 때 뜨는 에러 메세지
		...
		errMessage = URLEncoder.encode(errMessage, "UTF-8"); // encoding
